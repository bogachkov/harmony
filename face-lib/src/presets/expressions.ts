...
export const expressions = {
  ...
  happy: {
    brows: { outerLift: 0.005, arch: 0.6 },
    eyes: { openness: 0.85 },
  ...
  angry: {
    brows: { innerLift: -0.022, outerLift: 0.006, arch: 0.2 },
  ...
  sad: {
    brows: { innerLift: 0.018, outerLift: -0.006, arch: 0.7 },
    eyes: { openness: 0.6, tilt: -0.04 },
    mouth: { cornerLift: -0.022, width: 0.24 },
  } satisfies DeepPartial<FaceParams>,

  surprised: {
    brows: { ridgeY: 0.13, arch: 0.9, innerLift: 0.008, outerLift: 0.012 },
    eyes: { openness: 1.35 },
  ...
  fearful: {
    brows: { ridgeY: 0.11, innerLift: 0.012, outerLift: 0.006, arch: 0.4 },
    eyes: { openness: 1.25 },
  ...
  disgust: {
    brows: { innerLift: -0.018, outerLift: 0.002, arch: 0.3 },
    eyes: { openness: 0.65 },
    nose: { width: 0.17 },
